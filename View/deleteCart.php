...
<div class="divTableRow">
    <div class="divTableCell"> 
        <input type="text"  id="course_name" name="course_name" value="<?php echo $courseName ?>" disabled> 
    </div>
    <div class="divTableCell"> 
    <input type="Number" min="0" id="course_pricee" value="<?php echo $coursePrice ?>" name="course_price" disabled>
    </div>
