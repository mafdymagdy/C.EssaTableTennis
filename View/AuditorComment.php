...
<?php require_once("navbar.php") ?>
  ...
  require_once(__ROOT__ . "View/ViewAllAuditor.php");

  $model = new ContactsModel();
  $controller = new ContactController($model);
  $view = new ViewAllAuditor($controller, $model);
...
<style>
  ...
  #hero {
    background: url('images/all-icon/Communication.png') center center no-repeat;
...
<header>
            <div class="flex container">
                <a id="logo" href="#">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; communication between <br> students and admins </a>
                <nav>
                    ...
                    <ul id="nav-menu"> 
                        <li style="text-align: right"><a href="Auditor.php"><img src="images/miu-logo.jpg" alt="Logo" style="width:150px;height:100px;"></a></li>
                        
                        <li style="text-align: left"><a href=".php"> Send a survey </a></li>
...
<div class="divTableRow">
    ...
    <div class="divTableHead">Add or change Comment</div>
</div>
</div>
