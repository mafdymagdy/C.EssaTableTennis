...
<div class="divTableRow">
    ...
    <div class="divTableHead">CreatedAt</div>
    <div class="divTableHead">Delete</div>
</div>
</div>
<div class="divTableRow">
    <div class="divTableCell"> 
        <input type="text"  id="username" name="username" value="<?php echo $UserUsername ?>" disabled> 
    </div>
    
    <div class="divTableCell"> 
        <input type="text"  id="age" name="age" value="<?php echo $UserCreatedAt ?>" disabled> 
    </div>
