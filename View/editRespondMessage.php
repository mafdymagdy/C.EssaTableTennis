...
<title> Respond Specific Message </title>
...
?>
    ...
    <?php
$id = $_GET['id'];
foreach ($model->contacts as $message)
{
    if ($message->getID() == $id)
    {

        $adminRespond = $message->getAdminRespond();
...
<header>
            <div class="flex container">
                <a id="logo" href="#">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Respond Specific Message  </a>
                <nav>
                    ...
                    <ul id="nav-menu"> 
                        ...
                        <li style="text-align: left"><a href="RespondMessage.php"> Messages </a></li>
...
<body>
  ...
  <section id="hero">
    ...
    <form  method = "post" action="RespondMessage.php?action=edit">
...
<div class="divTableRow">
    ...
    <div class="divTableCell"> 
        <input type="varchar" maxlength="30" id="admin_respond" placeholder="Add New Respond" name="admin_respond" required value="<?php echo $adminRespond ?>"> 
    </div>
