...
<style>
  ...
  #hero {
    background: url('images/all-icon/messagehistory.png') center center no-repeat;
...
<table class="table table-bordered">
				<thead class="alert-info">
					<tr>
						<th>My Message about the course </th>
						<th> </th>
						<th> </th>
						<th> </th>
						<th> </th>
				...
				<tbody>
					<?php
						...
						$query = mysqli_query($conn, "SELECT * FROM `contactus` where user_id=$idd") or die(mysqli_error());
						while($fetch = mysqli_fetch_array($query)){
					?>
						<tr>
                            
							<td><?php echo $fetch['student_message']?></td>
							<td><?php echo $fetch['ispenalty']?></td>
							<td><?php echo $fetch['ispenalty']?></td>
							<td><?php echo $fetch['ispenalty']?></td>
							<td><?php echo $fetch['ispenalty']?></td>
							<td><?php echo $fetch['admin_respond']?></td>
						</tr>
					<?php
						}
					?>
