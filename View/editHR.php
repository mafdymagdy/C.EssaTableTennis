...
<header>
            <div class="flex container">
                <a id="logo" href="#">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Add or change <br> HR penalty </a>
                <nav>
                    ...
                    <ul id="nav-menu"> 
                        <li style="text-align: right"><a href="HR.php"><img src="images/miu-logo.jpg" alt="Logo" style="width:150px;height:100px;"></a></li>
                        
                        <li style="text-align: left"><a href="HRPenalty.php"> Add penalty to admins </a></li> 
...
<body>
  ...
  <section id="hero">
    ...
    <form  method = "post" action="HRPenalty.php?action=editHR">
...
<div class="divTableRow">
    ...
    <div class="divTableCell"> 
        <input type="varchar" maxlength="30" id="hr_penalty" placeholder="Add New Penalty" name="hr_penalty" required value="<?php echo $HRPenalty ?>"> 
    </div>
    

    <div class="divTableCell"> <button type="submit" class="btn btn-default">Confirm Penalty?</button> </div>
